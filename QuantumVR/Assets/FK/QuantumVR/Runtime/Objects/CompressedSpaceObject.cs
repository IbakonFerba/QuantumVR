...
namespace FK.QuantumVR.Objects
{
    ...
    /// </summary>
    [AddComponentMenu("QuantumVR/Compressed Space Object")]
    public class CompressedSpaceObject : CompressedSpaceEntity
    {
        ...
        public override void EnterPortal(Portal portal, Guid targetCell, bool doUpdate = true)
        {
            ...
            if (_portalCollisionObject == null)
            {
                ...
                foreach (Collider col in colliders)
                {
                    ...
                    QuantumVRLogger.LogVerbose($"Created Portal Traversal collision object for {this.name}", this);
                }
            }
        ...
        public void AddMaterial(Material material)
        {
            ...
            QuantumVRLogger.LogVerbose($"Added Material {material.name} to {this.name}", this);
        }
        ...
        public void RemoveMaterial(Material material)
        {
            ...
            QuantumVRLogger.LogVerbose($"Removed Material {material.name} from {this.name}", this);
        }
        ...
        {
            if (!_hasRenderer)
                QuantumVRLogger.LogWarning($"Cannot get materials from {this.name} because it has no renderer!", this);
