...
namespace FK.QuantumVR.Objects
{
    ...
    public class QuantumVRCamera : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            QuantumVRLogger.Log($"Enabled QuantumVR Camera {this.name} was marked as Main Camera", this);
        }
        ...
        private void Init()
        {
            ...
            quadRenderer.sharedMaterial.renderQueue = SettingsLoader.Settings[SettingsLoader.DEPTH_CLEAR_QUEUE_KEY].IntValue;
        ...
        public void TogglePortalTransition(bool enable, int targetLayer = 0, Portal portal = null)
        {
            ...
            if (!enable)
            {
                QuantumVRLogger.LogVerbose("Disabled Portal Transition Rendering", this);
                return;
            }
            ...
            QuantumVRLogger.LogVerbose("Enabled Portal Transition Rendering", this);
        }

        public void PausePortalTransition(bool pause)
        {
            _portalTransitionQuad.SetActive(!pause);
            QuantumVRLogger.LogVerbose(pause ? "Paused Portal Transition Rendering" : "Unpaused Portal Transition Rendering", this);
        }
    }
}