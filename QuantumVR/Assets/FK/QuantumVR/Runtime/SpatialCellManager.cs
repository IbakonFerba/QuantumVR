...
namespace FK.QuantumVR
{
    ...
    public class SpatialCellManager : Singleton<SpatialCellManager>
    {
        ...
        public Guid StartCell => _spatialCellMapData.StartCellGuid.Value;
        ...
        private void Init()
        {
            ...
            QuantumVRLogger.LogVerbose("Initialized Spatial Cell Manager", this);
        }
        ...
        {
#if UNITY_EDITOR
            QuantumVRLogger.LogVerbose("Updating Spatial Layers...");
...
#if UNITY_EDITOR
            stopwatch.Stop();
            QuantumVRLogger.Log($"Spatial Layer update took {stopwatch.ElapsedMilliseconds}ms");
#endif
        }
        ...
        {
#if UNITY_EDITOR
            QuantumVRLogger.LogVerbose($"Changing active Cell to {newActiveCell}");
#endif
        ...
        public bool IsInActiveCell(GameObject obj)
        {
            ...
            if (compressedSpaceEntity == null)
                QuantumVRLogger.LogError($"Cannot determine Spatial Cell of {obj.name} because it is not a Compressed Space Object", obj);
            return compressedSpaceEntity != null && compressedSpaceEntity.IsInActiveCell();
        }


        /// <summary>
        /// Sets the spatial cell of a compressed space entity as well as the ones of deep children if desired
        /// </summary>
        /// <param name="obj">The Object with a Compressed Space Entity to move</param>
        ...
        public void MoveObjectToCell(GameObject obj, Guid newSpatialCellGuid, bool setChildren, bool doUpdate = true)
        {
            CompressedSpaceEntity compressedSpaceEntity = obj.GetComponent<CompressedSpaceEntity>();
            if (compressedSpaceEntity == null)
            {
                QuantumVRLogger.LogError($"Cannot move {obj.name} because it is not a Compressed Space Object", obj);
                return;
            }

            compressedSpaceEntity.ChangeSpatialCell(newSpatialCellGuid, setChildren, doUpdate);
        }
