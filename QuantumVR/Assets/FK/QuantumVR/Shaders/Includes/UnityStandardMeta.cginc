/*
*   Modified from Unity built-in shader source to work with QuantumVR Object rendering. Copyright (c) 2016 Unity Technologies. MIT license (see license.txt)
*   
*   v1.0 10/2019
...
float4 frag_meta (v2f_meta i) : SV_Target
{
    ...
    performPortalClipping(data.posWorld);
